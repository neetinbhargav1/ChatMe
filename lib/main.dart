...
import 'package:chatapp/alias.dart';
...
void main() {
  ...
  runZoned<Future<void>>(() async {
    ...
    await Chat.reportError(error, stackTrace);
  });
}
...
class MainScreenState extends State<MainScreen>
    ...
    if (currentUserNo == null || currentUserNo.isEmpty)
      unawaited(Navigator.pushReplacement(
          ...
          new MaterialPageRoute(
              builder: (context) =>
              new LoginScreen(title: 'Sign in to ChatMe'))));
    else {
      setIsActive();
  ...
  Stream<MessageData> getUnread(Map<String, dynamic> user) {
    String chatId = Chat.getChatId(currentUserNo, user[PHONE]);
                                    ...
                                    return Theme(
                                      ...
                                      child: SimpleDialog(children: <Widget>[
                                        ListTile(
                                            ...
                                            subtitle: Padding(
                                                child: Text(
                                                  'Enjoying using ChatMe app? Rate us!',
                                                  textAlign: TextAlign.center,
                                                ),
                                                padding:
...
//                                          LaunchReview.launch();
                                        ...
                                        Center(
                                            child: RaisedButton.icon(
                                                ...
                                                onPressed: () {
                                                  launch(
                                                      'mailto:neetinbhargav1@gmail.com?subject=ChatApp%20Feedback');
                                                  Navigator.pop(context);
                                                }))
                                      ]),
                                    );
